...
const Androiddevelopment = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={appDevelopment} imgLeft={true} title="TechieHelp App Development Internship Program">
        <p>
          Build Android/iOS apps using Flutter or React Native. Hands-on learning with weekly challenges and expert mentorship to help you become a proficient mobile app developer.
        </p>
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our app development internship offers practical experience in building cross-platform mobile applications with real-world projects and dedicated mentor support.
        </p>
      ...
      <Section imgSrc={appDevelopment} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> Flutter, React Native, Dart, Firebase, APIs, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World Mobile App Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month App Development Internship — ₹999</h2>
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  🚀 Orientation & Setup<br />
                  🛠️ Flutter & React Native Basics
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Set up your development environment<br />
                  ✅ Learn Flutter widgets and React Native components<br />
                  ✅ Build your first mobile app screen
                </td>
              </tr>
              <tr className="border border-cyan-500">
                <td className="px-4 py-3 border border-cyan-500 align-top">Week 2</td>
                <td className="px-4 py-3 border border-cyan-500">
                  💡 State Management & Navigation<br />
                  🎯 Mentorship & AMA with Industry Experts
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Implement navigation between screens<br />
                  ✅ Manage app state using popular libraries<br />
                  ✅ Submit your project objective document
                </td>
              </tr>
              <tr className="border border-cyan-500">
                <td className="px-4 py-3 border border-cyan-500 align-top">Week 3</td>
                <td className="px-4 py-3 border border-cyan-500">
                  ⚙️ API Integration & Backend Setup<br />
                  🌐 App Deployment Workshop
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Connect your app to backend services<br />
                  ✅ Deploy your app to app stores or test platforms
                </td>
              </tr>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Submit your final app project<br />
