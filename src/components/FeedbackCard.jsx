...
const FeedbackCard = ({ content, name, title, img, rating }) => {
  ...
  return (
    <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card bg-gray-800">
      ...
      <p className="font-poppins font-normal text-[18px] leading-[32.4px] text-gray-900 dark:text-white my-6">
        {content}
      </p>
      ...
      <div className="flex flex-row items-center">
        ...
        <div className="flex flex-col ml-4">
          <h4 className="font-poppins font-semibold text-[20px] leading-[32px] text-gray-900 dark:text-white">
            {name}
          </h4>
          {title && (
            <p className="font-poppins font-normal text-[16px] leading-[24px] text-gray-500 dark:text-dimWhite">
              {title}
            </p>
          )}
        </div>
