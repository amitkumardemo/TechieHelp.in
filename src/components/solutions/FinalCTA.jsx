          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center w-full max-w-2xl">
              ...
              <a 
                ...
                className="group w-full sm:w-auto px-12 py-6 bg-black/10 backdrop-blur-xl border border-white/30 text-white font-black text-xl rounded-3xl hover:bg-black/20 transition-all flex items-center justify-center gap-3"
              >
                <span>Call Now</span>
