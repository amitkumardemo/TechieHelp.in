        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-8 rounded-[2.5rem] flex items-center justify-between backdrop-blur-xl"
            >
              <div>
                <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest block mb-1">Standard Sales Flow</span>
                <h4 className="text-2xl font-bold text-gray-900 dark:text-white">Without AI Automation</h4>
                <p className="text-sm text-red-400 mt-2">Slow manual follow-up logs only 5 clients.</p>
              </div>
              <div className="text-right">
                <span className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white/50">5</span>
            ...
            >
              <div>
                ...
                <h4 className="text-2xl font-bold text-gray-900 dark:text-white">With TechieHelp AI</h4>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-[#0a0a20] border border-gray-200 dark:border-white/10 p-8 rounded-[3.5rem] relative flex flex-col justify-between overflow-hidden shadow-2xl"
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400 mb-2">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">₹1,50,000</span>
                </div>
                <div className="w-full bg-gray-100 dark:bg-white/5 h-4 rounded-full overflow-hidden border border-white/5">
