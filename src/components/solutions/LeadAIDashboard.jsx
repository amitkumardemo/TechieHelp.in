    ...
    <div className="flex h-screen bg-[#030307] text-[#ebebed] font-sans overflow-hidden antialiased selection:bg-[#38bdf8]/30 selection:text-[#38bdf8]">
      ...
      {/* Mobile Backdrop */}
        ...
        <div>
          ...
          <div className="p-6 flex items-center gap-3 border-b border-white/[0.04]">
            ...
            <div>
              <h1 className="font-bold text-sm tracking-tight text-gray-900 dark:text-white leading-none">LeadAI</h1>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 flex flex-col h-screen overflow-y-auto scrollbar-hide pb-12 relative border-r border-white/[0.04]">
          {/* HEADER BAR */}
          <header className="sticky top-0 bg-[#030307]/70 backdrop-blur-md z-40 border-b border-white/[0.05] py-4 px-4 md:px-8 flex items-center justify-between">
            <button 
              onClick={() => setIsMobileMenuOpen(true)}
              className="lg:hidden mr-3 p-2 bg-white/[0.05] border border-white/[0.05] rounded-lg text-gray-300 hover:text-gray-900 dark:text-white"
            >
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-[10px] text-gray-600 dark:text-gray-400 font-mono">TechieHelp LeadAI Operating System</p>
              </div>
              ...
              >
                ...
                {activeTab === "overview" && (
                  <div className="space-y-8">
                    ...
                    {/* KPI Cards Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        ...
                        {filteredInbox.map(item => (
                          <div
                            ...
                            className={`p-4 cursor-pointer transition-colors relative text-left ${
                              selectedInboxId === item.id ? "bg-white/[0.03]" : "hover:card-glass-static"
                            }`}
                          >
                            {!item.read && (
                            ...
                            <div className="flex items-center gap-2 mb-1.5">
                              <span className={`text-[9px] px-1.5 py-0.5 rounded font-mono ${
                                ...
                                item.source === "Gmail" ? "bg-purple-500/10 text-[#38bdf8]" : "bg-green-500/10 text-green-400"
                              }`}>
                                {item.source}
                              </span>
                              <span className={`text-[9px] px-1.5 py-0.5 rounded font-mono ${
                            ...
                            <tr key={lead.id} className="hover:bg-white/[0.005] transition-colors">
                              ...
                              <td className="py-4">
                                <span className={`flex items-center gap-1 text-[11px] ${
                                  ...
                                  lead.status === "In Progress" ? "text-amber-400" : "text-[#38bdf8]"
                                }`}>
                ...
                {activeTab === "replies" && (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-2 gap-8 text-left">
                        ...
                        {calls.map(log => (
                          <div
                            ...
                            className={`p-4 cursor-pointer transition-colors ${
                              activeCallLogId === log.id ? "bg-white/[0.03]" : "hover:card-glass-static"
                            }`}
                          >
                      ...
                      <div className="lg:col-span-2 rounded-xl border border-white/[0.04] card-glass-static overflow-y-auto scrollbar-hide flex flex-col divide-y divide-white/[0.03] text-left">
                        ...
                        {whatsappChats.map(chat => (
                          <div
                            ...
                            className={`p-4 cursor-pointer transition-colors ${
                              selectedChatId === chat.id ? "bg-white/[0.03]" : "hover:card-glass-static"
                            }`}
                          >
                      ...
                      <div className="rounded-xl border border-white/[0.04] card-glass-static p-5 shadow-2xl flex flex-col justify-between space-y-4 relative">
                        <div>
                          <div className="flex justify-between items-center mb-3">
                            <div className="p-2 bg-purple-500/10 text-[#38bdf8] rounded-lg">
                      ...
                      <div className="rounded-xl border border-white/[0.04] card-glass-static p-5 shadow-2xl flex flex-col justify-between space-y-4 relative">
                        ...
                        <div className="border-t border-white/[0.04] pt-3 space-y-2 text-[10px] font-mono">
                          <div className="flex justify-between items-center">
                            ...
                            <button
                              onClick={() => copyToClipboard("https://api.techiehelp.in/v1/leadai/forms", "forms")}
                          ...
                          <p className="text-[9px] text-gray-600 dark:text-gray-400 card-glass-static p-1.5 rounded truncate">
                            https://api.techiehelp.in/v1/leadai/forms
                          </p>
                        </div>
                      </div>
                ...
                {activeTab === "settings" && (
                  <div className="space-y-6 text-left">
                    <div className="flex items-center justify-between border-b border-white/[0.05] pb-4">
                      <div>
                        <h2 className="text-md font-bold text-gray-900 dark:text-white uppercase tracking-wider">LeadAI Configuration Settings</h2>
        ...
        <aside className="w-80 bg-[#05050a]/60 backdrop-blur-2xl p-6 h-screen overflow-y-auto scrollbar-hide hidden xl:flex flex-col justify-between shrink-0">
          <div>
