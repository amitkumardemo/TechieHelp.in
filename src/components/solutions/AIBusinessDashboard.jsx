    ...
    <div className="bg-[#050510] min-h-screen text-gray-300 font-sans selection:bg-blue-500/30 pt-28 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-8">
          ...
          <span>Services</span>
          <span className="text-[#33bbcf]">→</span>
          <span className="text-gray-900 dark:text-white font-semibold">AI Business Dashboard</span>
        </div>
        ...
        <section className="mb-24 flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight mb-6 tracking-tighter">
              Track Your Growth <br />
              <span className="text-cyan-gradient font-bold">In One Real-time Screen</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="bg-orange-600 text-gray-900 dark:text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-orange-500 hover:scale-105 active:scale-95 transition-all shadow-xl flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:w-1/2 w-full relative flex justify-center">
            {/* Visual HUD Mockup */}
            <div className="relative w-full max-w-[500px] bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-gray-100 dark:bg-white/5 border border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Admins & Managers</p>
                    </div>
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-gray-100 dark:bg-white/5 border border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Real-Time Streams</p>
                    </div>
                  </div>
        ...
        <section className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">How Data Consolidates</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">See how your business operations feed into one visual UI.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#0a0a14] border border-gray-800 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">1. Multi-stream Feed</h3>
            ...
            <div className="bg-[#0a0a14] border border-gray-800 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2. AI Metric Analysis</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                Calculates conversion rates, call durations, lead values, and ROI statistics dynamically with optimized backend queries.
              </p>
            </div>
            <div className="bg-[#0a0a14] border border-gray-800 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. High-End visual UI</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
        ...
        <section className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">One-time build fees with full ownership. No monthly subscriptions.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Basic */}
            <div className="bg-[#0a0a14] border border-gray-800 p-8 rounded-3xl relative flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Basic Dashboard</h3>
                <p className="text-xs text-gray-500 mb-6 uppercase tracking-wider">Single Data Source</p>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-8">₹15,000</div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-orange-500 hover:text-gray-900 dark:text-white py-3 rounded-xl text-center font-bold transition-all text-sm"
              >
                Book Setup Call
              </a>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-600/20 to-yellow-600/10 border border-orange-500/30 p-8 rounded-3xl relative flex flex-col justify-between shadow-2xl">
              <div className="absolute top-4 right-4 bg-orange-600 text-gray-900 dark:text-white text-[9px] uppercase tracking-widest font-bold px-2 py-0.5 rounded">Popular</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Standard Dashboard</h3>
                <p className="text-xs text-orange-400 mb-6 uppercase tracking-wider">Real-time CRM Sync</p>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-8">₹30,000</div>
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400 mb-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-orange-600 hover:bg-orange-500 py-3 rounded-xl text-center font-bold transition-all text-sm text-gray-900 dark:text-white shadow-lg"
              >
                Book Setup Call
              </a>
            </div>
            ...
            <div className="bg-[#0a0a14] border border-gray-800 p-8 rounded-3xl relative flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Enterprise Analytics</h3>
                <p className="text-xs text-gray-500 mb-6 uppercase tracking-wider">Custom Complex Dashboards</p>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-8">Custom</div>
                <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400 mb-8">
        ...
        <section className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-12 backdrop-blur-xl text-center shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-yellow-500/10 opacity-30 -z-10" />
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6">See Your Growth Clearly</h2>
