      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative p-10 rounded-[3.5rem] bg-white/5 border border-white/10 backdrop-blur-2xl overflow-hidden"
          >
             <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/10 blur-[80px]" />
             
             <div className="space-y-8 relative z-10">
                {[
                  { label: "Lead arrives", icon: <ArrowRight className="text-blue-500" />, sub: "Customer fills contact form / WhatsApp" },
          ...
          >
             <div className="p-10 rounded-[2.5rem] bg-gradient-to-br from-red-600/20 to-transparent border border-red-500/25 backdrop-blur-xl">
                ...
                <h3 className="text-2xl font-black text-white mb-4 leading-snug uppercase tracking-tight">
