...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[95vh] flex items-center justify-center pt-32 pb-20 px-6 overflow-hidden bg-white dark:bg-[#050510]">
      {/* Deep glow blobs */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="lg:w-1/2 flex flex-col items-start text-left">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-gray-900 dark:text-white leading-tight tracking-tight mb-6 uppercase"
          >
            Never Miss <br />
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-xl mb-8 leading-relaxed font-medium"
          >
          ...
          >
            {trustIndicators.map((indicator, i) => (
              <motion.div
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-100 dark:bg-white/5 border border-white/5 backdrop-blur-md"
              >
          ...
          >
            ...
            <a
              href="#workflow"
              className="flex items-center justify-center gap-2 px-8 py-4 bg-gray-100 dark:bg-white/5 border border-white/15 text-gray-900 dark:text-white font-semibold text-sm rounded-xl hover:bg-gray-100 dark:bg-white/10 transition-all duration-200 backdrop-blur-md"
            >
              Watch Demo
            </a>
          </motion.div>
        ...
        >
          <div className="relative w-full rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(100,150,255,0.15)] border border-gray-200 dark:border-white/10 group bg-gray-100 dark:bg-white/5 backdrop-blur-md p-10 text-center">
            ...
            >
              ...
              <span className="text-gray-900 dark:text-white font-bold text-xs">AI Integrated</span>
            </motion.div>
            ...
            <div className="py-12 flex flex-col items-center justify-center">
              ...
              <h4 className="text-gray-900 dark:text-white font-extrabold text-xl mb-2 uppercase tracking-wide">TechieHelp Engine</h4>
              <p className="text-gray-600 dark:text-gray-400 text-xs max-w-[200px] mx-auto leading-relaxed">
