    ...
    <section className="py-32 bg-[#050510] px-6 relative overflow-hidden" id="live-demo">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="relative max-w-5xl mx-auto p-1 rounded-[3rem] bg-gradient-to-r from-blue-600/30 via-purple-600/30 to-blue-600/30 shadow-[0_0_100px_rgba(59,130,246,0.1)]">
           <div className="bg-[#0a0a1a] rounded-[2.9rem] overflow-hidden border border-gray-200 dark:border-white/10 p-4 md:p-8">
              {/* Dashboard Style Mockup */}
              <div className="flex items-center justify-between mb-8 px-4 py-3 bg-gray-100 dark:bg-white/5 rounded-2xl border border-white/5">
                 <div className="flex gap-2">
                    <div className="w-3 h-3 rounded-full bg-red-500/50" />
                    <div className="w-3 h-3 rounded-full bg-yellow-500/50" />
                    <div className="w-3 h-3 rounded-full bg-green-500/50" />
                 </div>
                 <div className="text-[10px] font-black text-gray-900 dark:text-white/20 uppercase tracking-[4px]">TechieHelp AI Dashboard v2.0</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 ...
                 <div className="md:col-span-2 space-y-4 p-6 bg-black/40 rounded-3xl border border-white/5 font-mono text-[10px] md:text-xs leading-relaxed">
                    <div className="flex gap-4">
                       ...
                       <span className="text-gray-900 dark:text-white/80">New lead detected: "Aditya Kumar"</span>
                    </div>
                    <div className="flex gap-4">
                       <span className="text-blue-400">[3:00:02 PM]</span>
                       <span className="text-gray-900 dark:text-white/80 animate-pulse">→ AI storing data in CRM... Done.</span>
                    </div>
                    <div className="flex gap-4">
                       <span className="text-[#33bbcf]">[3:00:04 PM]</span>
                       <span className="text-gray-900 dark:text-white/80">→ AI initiating call to +91 767XXXXXXX</span>
                    </div>
                    <div className="flex gap-4">
                       <span className="text-orange-400">[3:00:05 PM]</span>
                       <span className="text-gray-900 dark:text-white/80">→ Call Connected. Extracting requirements...</span>
                    </div>
                    <div className="flex gap-2 mt-4 pt-4 border-t border-white/5">
                       <span className="text-gray-900 dark:text-white/20 animate-typing overflow-hidden whitespace-nowrap border-r-4 border-white/40 font-bold uppercase tracking-widest text-[9px]">Analyzing intent... High Potential</span>
                    </div>
                 </div>
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="p-6 rounded-3xl bg-purple-600/10 border border-purple-500/20 flex items-center justify-between relative overflow-hidden">
                       ...
                       <div>
                          <div className="text-[9px] font-black text-[#33bbcf] uppercase tracking-widest mb-1">Database</div>
                          <div className="text-2xl font-black text-gray-900 dark:text-white">SYNCED</div>
                       </div>
                       <Database className="w-8 h-8 text-[#33bbcf]" />
                    </div>

                    <div className="p-6 rounded-3xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-between relative">
                       <div>
                          <div className="text-[9px] font-black text-gray-500 uppercase tracking-widest mb-1">Action Ready</div>
                          <div className="text-2xl font-black text-gray-900 dark:text-white animate-pulse">NOTIFY</div>
                       </div>
                       <Bell className="w-8 h-8 text-gray-900 dark:text-white/20" />
                    </div>
                 </div>
              </div>
