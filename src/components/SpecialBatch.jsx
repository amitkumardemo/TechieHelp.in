...
const SpecialBatch = () => {
  const benefits = [
    ...
    { icon: <TrendingUp className="w-6 h-6 text-[#33bbcf]" />, title: "Stipend", desc: "Based on performance & client satisfaction" },
  ...
  return (
    <div className="bg-white dark:bg-primary text-gray-900 dark:text-white min-h-screen font-poppins overflow-hidden pt-48">
      {/* Hero Section */}
        ...
        <div className={`${layout.sectionInfo} relative z-10`}>
          ...
          <div className="grid grid-cols-3 gap-8 mb-12 border-t border-white/5 pt-8 w-full max-w-[500px]">
            <div>
              ...
              <p className="text-[10px] text-gray-500 dark:text-dimWhite uppercase tracking-widest mt-1">Students</p>
            </div>
            <div>
              <h3 className="text-3xl font-bold text-secondary">95%</h3>
              <p className="text-[10px] text-gray-500 dark:text-dimWhite uppercase tracking-widest mt-1">Hired</p>
            </div>
            <div>
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">12LPA</h3>
              <p className="text-[10px] text-gray-500 dark:text-dimWhite uppercase tracking-widest mt-1">Highest PKG</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <p className="flex items-center gap-2 text-gray-500 dark:text-dimWhite text-sm font-medium">
             ...
             >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-black text-gray-900 dark:text-white">99.2%</p>
                  </div>
                </div>
             </motion.div>
             ...
             >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/20 flex items-center justify-center">
                    <Users className="w-5 h-5 text-[#33bbcf]" />
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-[#33bbcf] font-black">Elite Batch</p>
                    <p className="text-xl font-black text-gray-900 dark:text-white">Top 5% Talent</p>
                  </div>
                </div>
             </motion.div>
          </div>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX} border-t border-white/5 bg-[#05050a]`}>
        <div className="max-w-[1280px] mx-auto">
          <div className="text-center mb-20">
             <h2 className="text-[42px] font-black text-gray-900 dark:text-white uppercase tracking-tighter mb-4">The Elite <span className="text-gradient">Advantage</span></h2>
             <p className="text-gray-500 dark:text-dimWhite font-mono text-[11px] uppercase tracking-[4px]">Why our special batch stands out</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
            {benefits.map((benefit, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 rounded-[2rem] glass-morphism border-white/5 hover:bg-white/[0.04] hover:border-gray-200 dark:border-white/10 transition-all group"
              >
                ...
                <h4 className="text-xl font-black text-gray-900 dark:text-white mb-3 tracking-tight group-hover:text-secondary transition-colors">{benefit.title}</h4>
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-10">
            {domains.map((domain, i) => (
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-gray-100 dark:bg-white/5 rounded-bl-full opacity-50 transition-all group-hover:w-full group-hover:h-full group-hover:rounded-none group-hover:opacity-10 duration-700" />
                ...
                <h3 className="text-3xl font-black text-gray-900 dark:text-white mb-4 leading-tight">{domain.title}</h3>
                <p className="text-gray-500 dark:text-dimWhite leading-relaxed group-hover:text-gray-900 dark:text-white transition-colors">{domain.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX} bg-[#05050a]`}>
        <div className="max-w-[1280px] mx-auto">
          <div className="text-center mb-20">
             <h2 className="text-[40px] font-black text-gray-900 dark:text-white uppercase tracking-tighter">Roadmap to <span className="text-gradient">Excellence</span></h2>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 relative">
            ...
            <div className="absolute top-24 left-0 w-full h-[1px] bg-gray-100 dark:bg-white/10 hidden lg:block" />
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-white dark:bg-primary border-4 border-white/5 flex items-center justify-center mb-8 relative z-20 group">
                ...
                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-4 px-4">{step.title}</h4>
                <p className="text-gray-500 dark:text-dimWhite text-sm leading-relaxed px-6">{step.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX}`}>
        <div className="max-w-[900px] mx-auto p-12 rounded-[3.5rem] bg-blue-500/5 border border-white/5 backdrop-blur-3xl text-center relative overflow-hidden group">
          ...
          <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter uppercase italic">Who is this for?</h2>
          <p className="text-xl text-gray-500 dark:text-dimWhite leading-relaxed mb-10 max-w-[700px] mx-auto">
            Open to students from <span className="text-gray-900 dark:text-white font-bold">Any Year</span> with basic domain knowledge and a passion for building enterprise-grade software.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
              {["Any Academic Year", "Basic Knowledge Needed", "Industry Passion"].map((tag) => (
                <div key={tag} className="px-6 py-2 rounded-full border border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-white/5 text-[10px] font-black uppercase tracking-widest text-blue-300">
                  {tag}
                </div>
              ))}
          </div>
      ...
      <section className={`${styles.paddingX} ${styles.paddingY}`}>
        <div className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-black-gradient-2 rounded-[40px] shadow-2xl border border-white/5 backdrop-blur-3xl relative overflow-hidden group min-h-[350px]`}>
          ...
          <div className="flex-1 flex flex-col relative z-10">
            ...
            <p className={`${styles.paragraph} max-w-[500px] mt-8 text-gray-900 dark:text-white/50`}>
            ...
            <div className="mt-8 flex items-center gap-6">
               ...
               <p className="text-gray-500 dark:text-dimWhite font-bold text-xs uppercase tracking-[2px]">Joining Now</p>
            </div>
          </div>
