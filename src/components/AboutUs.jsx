  ...
  return (
    <div className="bg-[#030014] min-h-screen text-gray-300 font-sans selection:bg-purple-500/30 pt-28 pb-20 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* BREADCRUMB */}
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-8 font-mono">
          <a href="/" className="hover:text-purple-400 transition-colors">Home</a>
          <span className="text-purple-500/60 font-bold">/</span>
          <span className="text-white font-medium bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.1)]">About Us</span>
        </div>
        ...
        <section className="mb-28 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[78vh] relative">
          <div className="lg:col-span-7 space-y-8 relative z-10">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight drop-shadow-sm"
            >
              Building The Future <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 drop-shadow-[0_0_30px_rgba(168,85,247,0.35)]">
                Workforce With AI
              </span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-xl border-l-2 border-purple-500/30 pl-4 py-1.5 bg-gradient-to-r from-purple-500/5 to-transparent font-medium"
            >
            ...
            >
              <a
                href="#what-we-build"
                className="px-8 py-4 rounded-xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white shadow-xl shadow-purple-900/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 group relative overflow-hidden"
              >
              ...
              <a
                ...
                className="px-8 py-4 rounded-xl font-semibold bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-purple-500/60 shadow-lg backdrop-blur-md hover:scale-105 active:scale-95 transition-all"
              >
                Book Strategy Call
              </a>
              <a
                href="/project-portfolio"
                className="px-6 py-4 rounded-xl font-semibold text-gray-400 hover:text-white transition-all flex items-center gap-1 group"
              >
          ...
          <div className="lg:col-span-5 w-full relative">
            <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-6 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex items-center gap-2 border-b border-white/10 pb-4 mb-8">
                ...
                <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-purple-400">TechieHelp AI Ecosystem</span>
              </div>
              ...
              <div className="relative w-full aspect-[4/3] max-w-[420px] mx-auto z-10">
                ...
                <div 
                  className={`absolute top-[5%] left-[2%] w-[44%] p-3.5 rounded-2xl border transition-all duration-500 text-center flex flex-col items-center justify-center ${
                    heroActivities[activeActivityIdx].node === "lead"
                ...
                >
                  ...
                  <h4 className="text-xs font-bold text-white leading-tight">AI Lead Engine</h4>
                  <span className="text-[9px] text-gray-500 font-mono mt-0.5">Autopilot Qualifier</span>
                </div>

                {/* Top Right Node: AI Calling Agents */}
                <div 
                  className={`absolute top-[5%] right-[2%] w-[44%] p-3.5 rounded-2xl border transition-all duration-500 text-center flex flex-col items-center justify-center ${
                    heroActivities[activeActivityIdx].node === "call"
                      ? "bg-purple-600/15 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.35)] scale-[1.04]"
                      : "bg-black/60 border-white/5 opacity-50 hover:opacity-75"
                  }`}
                >
                  ...
                  <h4 className="text-xs font-bold text-white leading-tight">AI Calling Agents</h4>
                  <span className="text-[9px] text-gray-500 font-mono mt-0.5">Voice Dialer</span>
                </div>

                {/* Bottom Left Node: AI Workflow Automation */}
                <div 
                  className={`absolute bottom-[5%] left-[2%] w-[44%] p-3.5 rounded-2xl border transition-all duration-500 text-center flex flex-col items-center justify-center ${
                    heroActivities[activeActivityIdx].node === "workflow"
                      ? "bg-purple-600/15 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.35)] scale-[1.04]"
                      : "bg-black/60 border-white/5 opacity-50 hover:opacity-75"
                  }`}
                >
                  ...
                  <h4 className="text-xs font-bold text-white leading-tight">Workflow Automation</h4>
                  <span className="text-[9px] text-gray-500 font-mono mt-0.5">Operations Sync</span>
                </div>

                {/* Bottom Right Node: QualifyAI Dashboard */}
                <div 
                  className={`absolute bottom-[5%] right-[2%] w-[44%] p-3.5 rounded-2xl border transition-all duration-500 text-center flex flex-col items-center justify-center ${
                    heroActivities[activeActivityIdx].node === "dashboard"
                      ? "bg-purple-600/15 border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.35)] scale-[1.04]"
                      : "bg-black/60 border-white/5 opacity-50 hover:opacity-75"
                  }`}
                >
                  ...
                  <h4 className="text-xs font-bold text-white leading-tight">QualifyAI Dashboard</h4>
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] uppercase font-mono font-bold tracking-wider text-purple-400">Live Activity Simulator</span>
                  </div>
                ...
                <div className="bg-black/60 border border-white/10 rounded-2xl p-5 shadow-inner backdrop-blur-md relative overflow-hidden min-h-[96px] flex flex-col justify-center">
          ...
          <div 
            className="absolute bottom-[-4rem] left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center gap-2 cursor-pointer z-10 opacity-60 hover:opacity-100 hover:text-purple-400 text-gray-500 transition-all"
            onClick={() => {
        ...
        <section className="mb-28 border-t border-white/5 pt-24">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Milestones</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">Global Trust, Scale & Startup Milestones</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Milestone 1 */}
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                ...
                <h4 className="text-2xl font-extrabold text-purple-400">16+ Countries</h4>
            ...
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-lg">🚀</div>
                <h3 className="text-xl font-bold text-white">Proven Delivery</h3>
                <h4 className="text-2xl font-extrabold text-purple-400">100+ Projects</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-lg">🏆</div>
                <h3 className="text-xl font-bold text-white">Quality Commitment</h3>
                <h4 className="text-2xl font-extrabold text-purple-400">ISO 9001 Certified</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-lg">🎖</div>
                <h3 className="text-xl font-bold text-white">Rajasthan Startup Summit</h3>
                <h4 className="text-2xl font-extrabold text-purple-400">Selected Startup 2026</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-lg">🌊</div>
                <h3 className="text-xl font-bold text-white">Armenia Summit</h3>
                <h4 className="text-2xl font-extrabold text-purple-400">Armenia Summit 2026</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 hover:border-purple-500/30 p-8 rounded-3xl relative flex flex-col justify-between hover:bg-white/[0.04] transition-all">
              ...
              <div className="space-y-4">
                <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-lg">🥇</div>
                <h3 className="text-xl font-bold text-white">Startup of the Year</h3>
                <h4 className="text-2xl font-extrabold text-purple-400">JIET Universe Jodhpur</h4>
                <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <section className="mb-28 bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 space-y-6">
              <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Why We Started</span>
        ...
        <section className="mb-28">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Onboarding roadmap</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">Startup Timeline</h2>
            <p className="text-gray-400 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 max-w-6xl mx-auto">
            {/* 2023 */}
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl relative flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono font-bold text-purple-400">2023</span>
                <h3 className="text-base font-bold text-white mt-1.5 mb-2">TechieHelp Founded</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl relative flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono font-bold text-purple-400">2024</span>
                <h3 className="text-base font-bold text-white mt-1.5 mb-2">Services Expansion</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl relative flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono font-bold text-purple-400">2025</span>
                <h3 className="text-base font-bold text-white mt-1.5 mb-2">AI Solutions Launch</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-gradient-to-b from-purple-500/20 to-transparent border border-purple-500/30 p-6 rounded-2xl relative flex flex-col justify-between shadow-lg">
              <div>
                ...
                <h3 className="text-base font-bold text-white mt-1.5 mb-2">AI Employee Ecosystem</h3>
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl relative flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono font-bold text-purple-400">Future</span>
                <h3 className="text-base font-bold text-white mt-1.5 mb-2">Global AI Platform</h3>
                <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <section id="what-we-build" className="mb-28">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Solutions</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">What We Build</h2>
            <p className="text-gray-400 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a
              ...
              className="bg-white/[0.02] border border-white/5 hover:border-purple-500/35 p-6 rounded-2xl hover:bg-white/[0.04] transition-all group block"
            >
              ...
              <h3 className="text-base font-bold text-white mb-2">AI Lead Engine</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-base font-bold text-white mb-2">AI Calling Agents</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-base font-bold text-white mb-2">AI Workflow Automation</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            {/* Card 4 */}
            <a
              href="/services/ai-business-dashboard"
              className="bg-white/[0.02] border border-white/5 hover:border-purple-500/35 p-6 rounded-2xl hover:bg-white/[0.04] transition-all group block"
            >
              <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-all">
                <Activity className="w-5 h-5" />
              </div>
              <h3 className="text-base font-bold text-white mb-2">QualifyAI Dashboard</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <section className="mb-28 border-t border-white/5 pt-24">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Transformation</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">What Is An AI Employee?</h2>
            <p className="text-gray-400 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-red-500/[0.02] border border-red-500/10 p-8 rounded-3xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">Traditional Employee</h3>
            ...
            <div className="bg-gradient-to-b from-purple-500/10 to-transparent border border-purple-500/30 p-8 rounded-3xl relative overflow-hidden shadow-2xl">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">TechieHelp AI Employee</h3>
        ...
        <section className="mb-28 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-purple-900/20 to-transparent border border-purple-500/20 p-10 rounded-3xl">
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
              <Lightbulb className="text-purple-400 w-6 h-6" /> Our Mission
            </h2>
            <p className="text-base text-gray-300 leading-relaxed">
        ...
        <section className="mb-28 border-t border-white/5 pt-24">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Global Impact</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">TechieHelp Around The World</h2>
            <p className="text-gray-400 text-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              {mapPins.map((pin, idx) => (
                ...
                >
                  ...
                  <span className={`text-[10px] font-mono px-2 py-0.5 rounded ${
                    activePin === idx ? "bg-purple-500 text-white" : "bg-white/5 text-gray-500"
                  }`}>
                    Active Pin
                  </span>
                </button>
            ...
            <div className="lg:col-span-8 bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl flex flex-col justify-between">
              <div>
                <span className="text-xs font-mono uppercase tracking-wider text-purple-400 font-bold block mb-2">Active Reach</span>
              ...
              {/* Pulse labels */}
              <div className="border-t border-white/10 pt-6 flex flex-wrap gap-4 text-xs text-gray-500">
                <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5 text-purple-500" /> AI Solutions</span>
                <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5 text-purple-500" /> Automation Services</span>
                <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5 text-purple-500" /> Technology Services</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-28">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl text-center">
              <h3 className="text-3xl md:text-4xl font-extrabold text-white">16+</h3>
              <p className="text-xs text-gray-500 font-medium mt-1">Countries Reached</p>
            </div>
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl text-center">
              <h3 className="text-3xl md:text-4xl font-extrabold text-white">100+</h3>
              <p className="text-xs text-gray-500 font-medium mt-1">Projects Delivered</p>
            </div>
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl text-center">
              <h3 className="text-3xl md:text-4xl font-extrabold text-white">24/7</h3>
              <p className="text-xs text-gray-500 font-medium mt-1">AI Operations</p>
            </div>
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl text-center">
              <h3 className="text-3xl md:text-4xl font-extrabold text-white">2023</h3>
        ...
        <section className="mb-28">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Pillars</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">Why Businesses Choose TechieHelp</h2>
            <p className="text-gray-400 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
              ...
              <h3 className="text-base font-bold text-white mb-2">AI-First Approach</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
              ...
              <h3 className="text-base font-bold text-white mb-2">Custom Built Systems</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
              ...
              <h3 className="text-base font-bold text-white mb-2">24/7 Operations</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
              ...
              <h3 className="text-base font-bold text-white mb-2">Scalable Infrastructure</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 rounded-2xl">
              ...
              <h3 className="text-base font-bold text-white mb-2">Startup Agility</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <section className="mb-28 border-t border-white/5 pt-24">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Onboarding</span>
            ...
            {workSteps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-base font-bold text-white mt-1.5 mb-2">{step.title}</h3>
        ...
        <section className="mb-28 border-t border-white/5 pt-24">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Integrations</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">Technology Ecosystem</h2>
            <p className="text-gray-400 text-lg">
              Our AI Core integrates seamlessly with standard business APIs and LLM models:
            </p>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl max-w-3xl mx-auto text-center space-y-6">
            <div className="w-20 h-20 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center mx-auto border border-purple-500/30 animate-pulse">
              <BrainCircuit className="w-10 h-10" />
            </div>
            <h3 className="text-xl font-bold text-white">TechieHelp AI Core</h3>
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-xl mx-auto">
              {["OpenAI (GPT-4)", "Gemini 1.5 Pro", "Vapi Voice Engine", "WhatsApp Business Cloud API", "Google Sheets API", "HubSpot CRM", "Salesforce API", "Razorpay / Stripe Hooks", "Tally API Connector"].map((tech, idx) => (
                <span key={idx} className="bg-white/5 border border-white/5 px-3 py-1.5 rounded-lg text-xs font-semibold text-gray-300">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <section className="mb-28 text-center">
          <div className="inline-block bg-white/5 p-12 rounded-3xl border border-white/10 max-w-3xl w-full relative overflow-hidden shadow-2xl">
            ...
            <p className="text-purple-400 font-medium mb-8">Founder & CEO, TechieHelp</p>
        ...
        <section className="mb-28 bg-gradient-to-r from-purple-900/10 to-[#030014] border border-purple-500/20 p-10 md:p-14 rounded-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">We Build Systems, Not Dependency</h2>
        ...
        <section className="mb-20">
          <div className="bg-gradient-to-r from-purple-900/20 via-pink-900/10 to-blue-900/20 border border-white/10 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              <span className="text-xs font-mono uppercase tracking-widest text-purple-400 font-bold block">Get Started</span>
              <h2 className="text-3xl md:text-5xl font-extrabold text-white">Ready To Build Your AI Workforce?</h2>
              <p className="text-gray-400 leading-relaxed text-sm">
