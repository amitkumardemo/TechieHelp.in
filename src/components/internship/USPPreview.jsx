...
const USPPreview = () => {
  return (
    <section className="py-24 bg-white dark:bg-primary px-6 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
              {[
                ...
                { icon: <Calendar className="w-5 h-5 text-[#33bbcf]" />, text: "Attendance Tracking" },
                ...
                <motion.li
                  ...
                  viewport={{ once: true }}
                  className="flex items-center gap-3 text-gray-900 dark:text-white font-medium group"
                >
                  <div className="p-2 rounded-lg bg-gray-100 dark:bg-white/5 group-hover:bg-gray-100 dark:bg-white/10 transition-colors">
                    {item.icon}
                  </div>
                  {item.text}
                </motion.li>
          ...
          <div className="flex-1 relative">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative w-full max-w-2xl bg-[#0a0a0f] rounded-24 md:rounded-32 p-4 md:p-6 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] border border-gray-200 dark:border-white/10 perspective-1000"
            >
              {/* Sidebar Mock */}
              <div className="flex gap-4 min-h-[400px]">
                <div className="w-12 md:w-16 h-full flex flex-col items-center gap-6 py-4 border-r border-white/5">
                  <div className="btn-primary">T</div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/5">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-blue-600/10 border border-blue-600/20">
                        ...
                        <span className="text-[10px] font-bold text-gray-900 dark:text-white">Student ID: TECHIE-403</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-4 rounded-2xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10">
                      ...
                      <p className="text-2xl font-bold text-gray-900 dark:text-white font-poppins">12/15</p>
                    </div>
                    <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-gray-200 dark:border-white/10">
                  ...
                  <div className="space-y-3">
                    <p className="text-xs font-bold text-gray-600 dark:text-gray-400 mb-2">Upcoming Tasks</p>
                    {[1, 2].map((i) => (
                      <div key={i} className="p-4 rounded-xl bg-gray-100 dark:bg-white/5 border border-white/5 flex items-center justify-between group cursor-default">
                        <div className="flex items-center gap-3">
                          <div className={`w-2 h-2 rounded-full ${i === 1 ? 'bg-orange-500' : 'bg-blue-500'}`} />
                          <p className="text-xs text-gray-900 dark:text-white font-medium">Task {i === 1 ? '7: API Integration' : '8: Deploy to Production'}</p>
                        </div>
                        <span className="text-[10px] text-gray-500 px-2 py-1 rounded bg-gray-100 dark:bg-white/5">0d left</span>
                      </div>
                    ))}
                  </div>
                </div>
