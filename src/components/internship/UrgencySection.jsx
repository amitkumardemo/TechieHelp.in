      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto font-medium">
            Next Batch Starts on <span className="text-white font-bold">{formatDate()}</span>. Don't miss your chance!
          </p>
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 mb-12">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                <div className="w-20 md:w-28 h-20 md:h-28 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center text-4xl md:text-5xl font-black text-white shadow-2xl">
          ...
          <a 
            ...
            className="inline-block px-10 py-5 bg-red-600 hover:bg-red-700 text-white font-black text-lg rounded-2xl transition-all duration-300 shadow-[0_0_40px_rgba(220,38,38,0.3)] hover:shadow-[0_0_60px_rgba(220,38,38,0.5)] transform hover:scale-105 uppercase tracking-wider"
          >
