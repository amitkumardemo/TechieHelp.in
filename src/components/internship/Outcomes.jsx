        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {outcomes.map((outcome, i) => (
            <motion.div
              ...
              className="flex items-start gap-6 p-8 rounded-32 bg-white/5 border border-white/10 hover:bg-white/[0.07] transition-all group"
            >
              <div className="p-4 rounded-2xl bg-white/5 group-hover:scale-110 transition-transform shadow-lg">
                {outcome.icon}
              </div>
              <div>
