...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[100vh] flex flex-col justify-center pt-32 pb-20 overflow-hidden bg-white dark:bg-[#03030a] px-6 selection:bg-orange-500/30">
      ...
      <div className="container mx-auto max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-6 xl:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 mb-8 backdrop-blur-md shadow-[0_0_20px_rgba(249,115,22,0.15)] group"
          >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 dark:text-white mb-6 leading-[1.1] tracking-tight drop-shadow-xl"
          >
            Start Your <span className="text-cyan-gradient font-bold">Summer Internship 2026</span> <br className="hidden sm:block" />
            at Just ₹499
          </motion.h1>
          ...
          >
            ...
            >
              ...
              <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-[14px] bg-white dark:bg-[#03030a] px-8 text-lg font-black text-gray-900 dark:text-white backdrop-blur-3xl group-hover:bg-gradient-to-tr group-hover:from-white dark:group-hover:from-[#03030a] group-hover:to-orange-100 dark:group-hover:to-orange-900/40 transition-all gap-3">
                Apply Now – ₹499 <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </span>
            </a>

            <button className="group w-full sm:w-auto h-16 px-8 bg-gray-100 dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white font-bold rounded-2xl hover:bg-gray-100 dark:bg-white/10 hover:border-gray-300 dark:border-white/20 transition-all duration-300 flex items-center justify-center gap-3 text-lg">
              <PlayCircle className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:text-white transition-colors" />
              Start Free Demo
            </button>
          </motion.div>
          ...
          >
            <div className="flex -space-x-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-white dark:border-[#03030a] bg-gray-200 dark:bg-gray-800" />
              ))}
              <div className="btn-primary">+15k</div>
            </div>
            <div className="text-left flex flex-col justify-center">
              <div className="flex items-center gap-1 text-yellow-400">
                {[1, 2, 3, 4, 5].map((_, i) => <Star key={i} className="w-3.5 h-3.5 fill-current" />)}
              </div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400"><span className="text-gray-900 dark:text-white font-bold">15,000+</span> Students Enrolled</p>
            </div>
          </motion.div>
        </div>
