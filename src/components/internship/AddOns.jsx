    ...
    <section className="py-20 bg-primary px-6">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Choose from our premium add-ons to enhance your internship experience.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {addons.map((addon, i) => (
            <motion.div
              ...
              className="p-6 rounded-3xl bg-white/5 border border-white/10 flex flex-col items-center text-center group cursor-default"
            >
              ...
              <div className="mt-auto pt-6 border-t border-white/5 w-full flex items-center justify-between">
                <span className="text-lg font-black text-white">₹{addon.price}</span>
                <button className="p-2 rounded-full bg-white/10 hover:bg-blue-600 transition-colors">
