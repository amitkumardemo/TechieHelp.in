...
const MERN = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={mern} imgLeft={true} title="TechieHelp MERN Stack Developer Internship Program">
        <p>
          Work on full-stack applications using MongoDB, Express.js, React.js, and Node.js. Gain hands-on experience with real projects and expert mentorship.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our MERN stack internship offers practical experience in building full-stack web applications with real-world projects and dedicated mentor support.
        </p>
      ...
      <Section imgSrc={mern} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> MongoDB, Express.js, React.js, Node.js, REST APIs, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World MERN Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month MERN Stack Developer Internship — ₹1499</h2>
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  🚀 Introduction to MERN Stack<br />
                  🛠️ MongoDB & Express.js Basics
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn MongoDB and Express.js<br />
                  ✅ Build backend APIs
                </td>
              </tr>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  💡 React.js & Node.js Fundamentals<br />
                  🎯 Mentorship & AMA with Industry Experts
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Understand React and Node.js<br />
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        <PriceBox
          ...
          features={[
            ...
            "Real-World MERN Projects & Deployment",
            "🎯 Internship Benefits",
        ...
        />
        <PriceBox
          title="🔸 2-Month Internship — ₹2499"
          price="₹2499"
          offer="₹5,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger MERN Developer Profile! 🚀",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Certificate of Excellence for Top MERN Developers",
            ...
            "⚛️ Full MERN Stack Project with Deployment",
            "🔥 MongoDB, Express.js, React.js, Node.js Basics",
            ...
            "✅ MERN Projects, Resume Boost, LinkedIn Badge",
