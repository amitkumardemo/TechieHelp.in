        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'MERN stack overview & expectations' },
              { type: 'normal', text: 'Tool setup guidance (VS Code, Git, GitHub)' },
              { type: 'normal', text: 'Introduction to internship workflow' },
              { type: 'project', level: 'beginner', title: 'MERN Stack Development Environment Setup', subtitle: 'Set up your complete MERN development environment' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced React concepts (Context API, Custom Hooks)' },
              { type: 'normal', text: 'React Router for navigation' },
              { type: 'normal', text: 'API integration with React' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'Complete React Frontend Application', subtitle: 'Build a full-featured React app with routing and API calls' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <ul className="flex flex-wrap gap-3 mb-3">
                <li className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full text-sm">✔ Live MERN Stack Projects</li>
