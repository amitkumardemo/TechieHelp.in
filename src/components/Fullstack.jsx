        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'beginner', title: 'Full Stack Development Environment Setup', subtitle: 'Set up your complete development environment' },
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'beginner', title: 'Frontend Static Website Project', subtitle: 'Build a responsive landing page with HTML/CSS/JS' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'Interactive Frontend Application', subtitle: 'Create a dynamic web app with advanced CSS and JS' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'React Frontend Application', subtitle: 'Build reusable React components and manage state' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-yellow-300 font-bold">Full Stack Development</span> Internship & Training Program
              </h1>
              <h2 className="text-xl md:text-2xl font-medium mb-2 leading-relaxed">
                 Master Frontend + Backend! Build Complete Web Applications from Scratch and Get Placed with ₹10-18 LPA Salary
              </h2>
              <p className="text-base mb-2 leading-relaxed">
                 This is NOT just a course! It's a 6-month structured full stack internship with live projects, 1-on-1 mentor guidance, and guaranteed placement support. Students who complete this program land jobs in top companies like Infosys, TCS, Wipro, and startups!
              </p>
              <ul className="flex flex-wrap gap-3 mb-3">
                <li className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full text-sm">✔ Live Full Stack Projects</li>
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Master industry-standard full stack development tools and frameworks used by developers to build complete web applications from frontend to backend.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 text-gray-900">
              ...
              <h3 className="text-xl font-semibold mb-2">TechieHelp Full Stack Development Internship Certificate</h3>
