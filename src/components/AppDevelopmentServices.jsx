    ...
    <div className="min-h-screen pt-20 bg-white dark:bg-primary text-gray-900 dark:text-white">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            ...
            <p className="text-lg mb-6">
              From startups to enterprises, we design and develop high-quality
              mobile applications tailored to your unique business needs. Our
              team specializes in creating intuitive, scalable, and feature-rich
              apps that provide seamless user experiences across iOS and
              Android. With a focus on performance, security, and innovation, we
              transform your ideas into powerful mobile solutions that engage
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-12 text-center">
              Services We <span className="text-[#33bbcf]">Offer</span>
            </h2>
            <h1 className="text-4xl font-bold mb-4">
              Our App Development Services
            </h1>
            <p className="text-lg mb-6">
              We provide end-to-end mobile app development solutions for
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-12 text-center">
              Technology We <span className="text-[#33bbcf]">Use</span>
            </h2>
            <h1 className="text-4xl font-bold mb-4">
              Driving Innovation and Performance
            </h1>
            <p className="text-lg mb-6">
              Leveraging the latest tools and frameworks, we build scalable and
            ...
            {[
              ...
              >
                ...
                <a
                  href={
                    index === 0
                      ? "https://calendar.app.google/XY3C9NoNJuDAtbZp9"
                      : index === 1
                      ? "https://calendar.app.google/XY3C9NoNJuDAtbZp9"
                      : "https://calendar.app.google/XY3C9NoNJuDAtbZp9"
                  }
