...
import { seo, technology, basic, classic, premium, choose, apps } from "../assets";
...
const features = [
  ...
  },
  {
    ...
    title: "Local SEO",
    description:
      "Optimize your online presence to attract local customers and improve local search rankings.",
  ...
  },
  {
    ...
    description:
      "Track performance with detailed analytics and regular reports to measure SEO success.",
  ...
  },
  {
    ...
    title: "Mobile SEO",
    description:
      "Ensure your website is optimized for mobile devices to capture the growing mobile audience.",
  ...
  },
  {
    ...
    title: "Link Building",
    description:
      "Build high-quality backlinks to improve domain authority and search engine rankings.",
  ...
  },
  {
    ...
    title: "SEO Audits",
    description:
      "Comprehensive audits to identify issues and opportunities for SEO improvement.",
  ...
  },
  {
    ...
    description:
      "We work tirelessly to deliver results that exceed your expectations and drive business growth.",
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
            ...
            >
              ...
              >
                We provide exceptional SEO optimization services tailored to your needs with cutting-edge technology and expert team
              </motion.p>
            </motion.div>
          </div>
