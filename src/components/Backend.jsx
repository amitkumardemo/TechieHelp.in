...
const Backend = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={backend} imgLeft={true} title="TechieHelp Back-End Developer Internship Program">
        <p>
          Work with server-side logic, databases, and APIs using languages like Java, Python, or Node.js. Gain hands-on experience with real projects and expert mentorship.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our back-end internship offers practical experience in building server-side applications and APIs with real-world projects and dedicated mentor support.
        </p>
      ...
      <Section imgSrc={backend} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> Java, Python, Node.js, Express, Databases, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World Back-End Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month Back-End Developer Internship — ₹999</h2>
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ...
                  🛠️ Java & Python Basics
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn server-side programming<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  💡 API Development & Security<br />
                  🎯 Mentorship & AMA with Industry Experts
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Build secure APIs<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ⚙️ Database Management & Deployment<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Submit final back-end project<br />
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <PriceBox
          ...
          offer="₹3,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger Back-End Developer Profile! 🚀",
            ...
            "⚛️ API Security & Cloud Deployment",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Certificate of Excellence for Top Back-End Developers",
            ...
            "🔥 Java, Python, Node.js, Express Basics",
            ...
            "✅ Backend Projects, Resume Boost, LinkedIn Badge",
