        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'Tool setup guidance (Node.js, Git, Postman)' },
        ...
        rows: [
          {
            ...
            includes: [
              { type: 'normal', text: 'Introduction to Backend Development fundamentals' },
              { type: 'normal', text: 'Understanding APIs, servers & databases' },
              { type: 'normal', text: 'Basic JavaScript/Node.js concepts' },
              { type: 'normal', text: 'Weekly doubt-solving session with mentor' },
              { type: 'project', level: 'beginner', title: 'Basic API Development Project', subtitle: 'Create a simple REST API with Node.js' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Database management with MongoDB/PostgreSQL' },
              { type: 'normal', text: 'CRUD operations & data modeling' },
              { type: 'normal', text: 'Express.js framework basics' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'Database-Driven API Project', subtitle: 'Build an API with database integration' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'JWT tokens & security best practices' },
              { type: 'normal', text: 'Error handling & validation' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'hard', title: 'Secure API with Authentication', subtitle: 'Implement JWT auth in your API' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced API development' },
              { type: 'normal', text: 'RESTful design principles' },
              { type: 'normal', text: 'API documentation with Swagger' },
              { type: 'project', level: 'beginner', title: 'Comprehensive API Development', subtitle: 'Build a full-featured REST API' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'API testing & debugging' },
              { type: 'project', level: 'intermediate', title: 'Microservices API Project', subtitle: 'Create multiple interconnected services' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Caching with Redis' },
              { type: 'normal', text: 'Performance optimization' },
              { type: 'normal', text: 'Load balancing concepts' },
              { type: 'project', level: 'intermediate', title: 'High-Performance API Project', subtitle: 'Optimize API with caching and monitoring' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Real-time communication (WebSockets)' },
              { type: 'normal', text: 'Background job processing' },
              { type: 'normal', text: 'File upload & storage' },
              { type: 'project', level: 'hard', title: 'Real-Time Application Project', subtitle: 'Build an app with WebSocket integration' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Cloud deployment (AWS/Heroku)' },
              { type: 'normal', text: 'CI/CD pipeline basics' },
              { type: 'normal', text: 'Monitoring & logging' },
              { type: 'project', level: 'hard', title: 'Cloud-Deployed Application', subtitle: 'Deploy your backend to the cloud' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Code review & best practices' },
              { type: 'normal', text: 'Security hardening' },
              { type: 'normal', text: 'Documentation & presentation' },
              { type: 'project', level: 'hard', title: 'Production-Ready Backend Project', subtitle: 'Complete full-stack backend application' },
        ...
        rows: [
          {
            timeline: 'Day First',
            includes: [
              { type: 'normal', text: 'Advanced backend development' },
              { type: 'normal', text: 'GraphQL API development' },
              { type: 'project', level: 'intermediate', title: 'GraphQL API Module', subtitle: 'Intermediate project kickoff' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Monday to Saturday', includes: [] },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Serverless architecture' },
              { type: 'normal', text: 'AWS Lambda & serverless functions' },
              { type: 'project', level: 'intermediate', title: 'Serverless Backend Project', subtitle: 'Build serverless APIs with AWS' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced database concepts' },
              { type: 'normal', text: 'Database optimization & indexing' },
              { type: 'project', level: 'intermediate', title: 'Optimized Database Design', subtitle: 'Design and optimize complex databases' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Message queues & async processing' },
              { type: 'normal', text: 'Event-driven architecture' },
              { type: 'project', level: 'hard', title: 'Event-Driven Backend System', subtitle: 'Hard project kickoff' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced security & encryption' },
              { type: 'normal', text: 'API rate limiting & throttling' },
              { type: 'project', level: 'hard', title: 'Secure Enterprise Backend', subtitle: 'Implement advanced security measures' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Real-world backend projects' },
              { type: 'normal', text: 'Open-source contributions' },
              { type: 'normal', text: 'Resume & portfolio project mapping' },
              { type: 'project', level: 'hard', title: 'Final Industry-Level Backend Project', subtitle: 'Complete professional backend application' },
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'hard', title: 'Enterprise-Level Backend System', subtitle: 'Hard project kickoff' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Monday to Saturday', includes: [] },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Scalability & performance tuning' },
              { type: 'normal', text: 'Load testing & monitoring' },
              { type: 'project', level: 'hard', title: 'Scalable Backend Architecture', subtitle: 'Design systems for high traffic' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'DevOps integration' },
              { type: 'normal', text: 'Automated testing & deployment' },
              { type: 'project', level: 'hard', title: 'CI/CD Pipeline Implementation', subtitle: 'Set up automated deployment pipelines' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Code quality & refactoring' },
              { type: 'normal', text: 'Technical debt management' },
              { type: 'project', level: 'hard', title: 'Code Quality & Testing Suite', subtitle: 'Implement comprehensive testing and refactoring' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'hard', title: 'Final Internship Project Submission', subtitle: 'Complete and submit final backend project' },
          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-yellow-300 font-bold">Backend Development</span> Internship & Training Program
              </h1>
              <h2 className="text-xl md:text-2xl font-medium mb-2 leading-relaxed">
                Master server-side development, APIs, databases, and scalable architectures to build robust backend systems and earn a verified internship certificate that helps in placements.
              </h2>
              <p className="text-base mb-2 leading-relaxed">
                This is not just a course. It’s a structured internship experience with live backend projects, mentor guidance, recommendation letter, and placement-focused support.
              </p>
              <ul className="flex flex-wrap gap-3 mb-3">
                <li className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full text-sm">✔ Live Internship Projects</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 group">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Real-World Backend Development Projects for Resume</h3>
...
{/* Mentor 1 */}
  ...
  <div className="text-center mb-4">
    ...
    <p className="text-sm text-blue-600 font-medium">
      Backend Developer Expert • 2+ Years Experience
    </p>
  </div>

  {/* Description */}
  <p className="text-gray-700 mb-4 text-center text-sm leading-relaxed">
    Backend Developer professional at <span className="font-medium">TechieHelp</span> with 2+ years of
    hands-on experience in building scalable APIs, database management,
    and guiding students in real-world backend development practices.
  </p>
  ...
  <div className="mb-4">
    ...
    <ul className="space-y-2 text-gray-700 text-sm">
      <li className="flex items-start gap-2">
        ...
        <span>Practical backend development concepts & fundamentals</span>
      </li>
      <li className="flex items-start gap-2">
        <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
        <span>Hands-on API development & database management guidance</span>
      </li>
      <li className="flex items-start gap-2">
        <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
        <span>Project-based mentoring aligned with industry backend standards</span>
      </li>
      <li className="flex items-start gap-2">
        <CheckCircle className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
        <span>Career guidance for Backend Development & Full-Stack roles</span>
      </li>
    </ul>
  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Through TechieHelp's comprehensive training, real-world projects, and expert mentorship, you'll be prepared for high-demand roles in backend development across startups and established companies.
            </p>
          </div>
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Master industry-standard backend development tools and frameworks used by developers to build scalable and robust server-side applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://nodejs.org/static/images/logo.svg" alt="Node.js" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Node.js</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://expressjs.com/images/express-facebook-share.png" alt="Express.js" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Express.js</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://webassets.mongodb.com/_com_assets/cms/mongodb-logo-rgb-j6w271g1xn.jpg" alt="MongoDB" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">MongoDB</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://www.postgresql.org/media/img/about/press/elephant.png" alt="PostgreSQL" className="w-8 h-8 object-contain mx-auto mb-2" />
            ...
            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://fastapi.tiangolo.com/img/logo-margin/logo-teal.png" alt="FastAPI" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">FastAPI</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://redis.io/images/redis-white.png" alt="Redis" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Redis</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://www.docker.com/wp-content/uploads/2021/10/Moby-logo-white.png" alt="Docker" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Docker</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Docker_%28container_engine%29_logo.svg/1280px-Docker_%28container_engine%29_logo.svg.png" alt="Docker" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Docker</h3>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://jwt.io/img/logo-asset.svg" alt="JWT" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">JWT</h3>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://www.postman.com/assets/logos/postman-logo-stacked.svg" alt="Postman" className="w-8 h-8 object-contain mx-auto mb-2" />
              <h3 className="text-xs font-semibold text-gray-800">Postman</h3>
            </div>

            <div className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition-shadow duration-200 text-center">
              <img src="https://aws.amazon.com/architecture/icons/aws-logo.png" alt="AWS" className="w-8 h-8 object-contain mx-auto mb-2" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 text-gray-900">
              ...
              <h3 className="text-xl font-semibold mb-2">TechieHelp Backend Development Internship Certificate</h3>
