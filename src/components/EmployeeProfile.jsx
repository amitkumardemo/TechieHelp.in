...
const EmployeeProfile = ({ employee }) => {
  ...
  if (!employee) {
    return (
      <div className="min-h-screen flex items-center justify-center text-gray-900 dark:text-white bg-black">
        <Helmet>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">The profile you are looking for does not exist or has been moved.</p>
        </div>
      </div>
    );
  }
      ...
      <div className={`${NAVBAR_HEIGHT} relative z-10 px-6 pb-20`}>
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 bg-gray-100 dark:bg-white/5 backdrop-blur-2xl rounded-[2.5rem] border border-gray-200 dark:border-white/10 p-8 md:p-12 shadow-2xl">
              ...
              <div className="relative group">
                ...
                <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-gray-200 dark:border-white/10 ring-8 ring-blue-500/5">
                  <img
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 text-gray-300">
                      <span className="text-[#33bbcf] font-mono text-sm">ID:</span>
                      <span className="font-mono text-sm font-bold tracking-widest">{employee.id}</span>
                    </div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 text-gray-300">
                      <span className="text-[#33bbcf] font-bold text-sm">EXP:</span>
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            >
              ...
              <div className="bg-gray-100 dark:bg-white/5 backdrop-blur-xl rounded-[2rem] border border-gray-200 dark:border-white/10 p-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {employee.skills.split(',').map((skill, index) => (
                    <motion.span
                      ...
                      key={index}
                      className="px-6 py-3 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl text-gray-300 text-sm font-medium transition-colors"
                    >
                      {skill.trim()}
                    </motion.span>
                  ))}
            ...
            >
              {/* Contact Card */}
              <div className="bg-gray-100 dark:bg-white/5 backdrop-blur-xl rounded-[2rem] border border-gray-200 dark:border-white/10 p-8">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Contact Details</h3>
                <div className="space-y-6">
                  <div className="group flex items-start gap-4 p-4 rounded-2xl bg-gray-100 dark:bg-white/5 hover:bg-gray-100 dark:bg-white/10 transition-colors border border-transparent hover:border-blue-500/20">
                  ...
                  <div className="group flex items-start gap-4 p-4 rounded-2xl bg-gray-100 dark:bg-white/5 hover:bg-gray-100 dark:bg-white/10 transition-colors border border-transparent hover:border-purple-500/20">
                    <div className="p-2 bg-purple-500/10 rounded-lg text-[#33bbcf]">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {employee.linkedInProfile && (
                    <a
                      ...
                      className="flex items-center justify-between p-4 bg-gray-100 dark:bg-white/5 hover:bg-[#0077b5] text-gray-300 hover:text-gray-900 dark:text-white rounded-2xl transition-all border border-white/5 group"
                    >
                  ...
                  {employee.githubProfile && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between p-4 bg-gray-100 dark:bg-white/5 hover:bg-[#24292e] text-gray-300 hover:text-gray-900 dark:text-white rounded-2xl transition-all border border-white/5 group"
                    >
