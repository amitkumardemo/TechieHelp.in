...
const AIML = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={aiml} imgLeft={true} title="TechieHelp AI/ML Developer Internship Program">
        <p>
          Work on AI models, machine learning algorithms, and real-world datasets using Python and popular libraries. Gain hands-on experience with real projects and expert mentorship.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our AI/ML internship offers practical experience in building intelligent systems with real-world projects and dedicated mentor support.
        </p>
      ...
      <Section imgSrc={aiml} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> Python, TensorFlow, Scikit-learn, Pandas, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World AI/ML Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month AI/ML Developer Internship — ₹999</h2>
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ...
                  🛠️ Python Basics & Libraries
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn Python fundamentals<br />
                  ✅ Explore AI/ML libraries
                </td>
              </tr>
              <tr className="border border-cyan-500">
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ⚙️ Data Processing & Visualization<br />
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <PriceBox
          ...
          offer="₹3,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger AI/ML Developer Profile! 🚀",
            ...
            "⚛️ Model Deployment & Cloud Integration",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Cloud Deployment & Big Data",
            "Final Hackathon + T-Shirt + YouTube Feature",
            "Certificate of Excellence for Top AI/ML Developers",
            ...
            "✅ AI/ML Projects, Resume Boost, LinkedIn Badge",
