...
const AI = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={chatbot} imgLeft={true} title="TechieHelp Artificial Intelligence Internship Program">
        <p>
          Implement AI models in Python. Work on projects like image recognition, chatbots & data prediction with expert mentorship and hands-on experience.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our AI internship offers practical experience in building AI models and real-world projects with dedicated mentor support.
        </p>
      ...
      <Section imgSrc={chatbot} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> Python, TensorFlow, Keras, OpenCV, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World AI Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month Artificial Intelligence Internship — ₹999</h2>
          ...
          <table className="min-w-full text-left text-white border border-cyan-500 rounded-lg">
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn Python programming<br />
                  ✅ Understand AI fundamentals<br />
                  ✅ Start building simple AI models
                </td>
              </tr>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Understand ML algorithms<br />
                  ✅ Build and train models<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ...
                  ✅ Deploy AI projects on cloud platforms
                </td>
              </tr>
              <tr className="border border-cyan-500">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <PriceBox
          ...
          offer="₹3,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger AI Developer Profile! 🚀",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Advanced AI Research + Deep Learning",
            "Portfolio Building & Client Projects",
            "Final Hackathon + T-Shirt + YouTube Feature",
            "Certificate of Excellence for Top AI Developers",
            ...
            "⚛️ Full AI Stack Project with Deployment",
            "🔥 Python, TensorFlow, Keras, OpenCV Basics",
            ...
            "✅ AI Projects, Resume Boost, LinkedIn Badge",
