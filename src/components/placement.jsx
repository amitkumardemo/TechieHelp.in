      ...
      <section className="relative z-10 pt-32 pb-20 px-6 overflow-hidden min-h-[90vh] flex flex-col justify-center border-b border-white/5">
        <div className="max-w-6xl mx-auto text-center relative">
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-10 max-w-3xl mx-auto font-light leading-relaxed">
            Master <span className="text-white font-medium">DSA</span>, optimize your <span className="text-white font-medium">LinkedIn</span>, and ace <span className="text-white font-medium">system design</span> with 1-on-1 mock interviews and guaranteed placement support.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button onClick={() => document.getElementById('enroll').scrollIntoView({ behavior: 'smooth' })} className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(37,99,235,0.4)]">
              <span>Enroll Now — ₹999</span>
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl border border-white/10 transition-all duration-300 hover:scale-105 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 border border-white/10 backdrop-blur-lg rounded-2xl p-6 transform hover:-translate-y-1 transition duration-300 group">
              <Trophy className="w-8 h-8 text-yellow-400 mb-3 mx-auto group-hover:scale-110 transition-transform" />
              <div className="text-2xl font-bold text-white mb-1">₹12 LPA</div>
              <div className="text-sm text-gray-400 uppercase tracking-wider">Highest Package</div>
            </div>
            <div className="bg-white/5 border border-white/10 backdrop-blur-lg rounded-2xl p-6 transform hover:-translate-y-1 transition duration-300 group">
              ...
              <div className="text-sm text-gray-400 uppercase tracking-wider">Top Campus Hires</div>
            </div>
            <div className="bg-white/5 border border-white/10 backdrop-blur-lg rounded-2xl p-6 transform hover:-translate-y-1 transition duration-300 group">
              <Star className="w-8 h-8 text-purple-400 mb-3 mx-auto group-hover:scale-110 transition-transform" />
      ...
      <section className="py-24 px-6 bg-[#0a0a0a] relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Everything you need to crack top product and service-based companies.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <Brain className="w-8 h-8 text-purple-400" />, title: "Aptitude & Logical Reasoning Practice", desc: "300+ questions with solutions and time-saving strategies." },
              ...
              { icon: <Briefcase className="w-8 h-8 text-indigo-400" />, title: "Domain Specific Interview Prep", desc: "Tailored prep for FAANG, product-based, and service-based companies." },
              ...
              <div key={index} className="bg-white/5 border border-white/10 rounded-2xl p-6 shadow-xl hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:bg-white/10 transition duration-300 group">
      ...
      <section className="py-24 px-6 bg-[#050505] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="bg-[#0a0a0a] border border-blue-500/30 rounded-3xl p-10 md:p-14 shadow-[0_0_50px_rgba(37,99,235,0.15)] relative overflow-hidden group">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white relative z-20">Exclusive Paid Internship Opportunity</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left max-w-3xl mx-auto mb-8 relative z-20">
              <div className="flex items-start gap-3 bg-white/5 p-4 rounded-xl border border-white/5 hover:bg-white/10 transition-colors">
      ...
      <section className="py-24 px-6 bg-[#0a0a0a] relative">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Join hundreds of students who transformed their careers with us.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 shadow-xl relative overflow-hidden group">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">Rahul Sharma</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 shadow-xl relative overflow-hidden group">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">Priya Patel</h3>
      ...
      <section className="py-24 px-6 bg-[#050505] relative w-full overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Invest in your career. Select the add-ons that fit your needs.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Base Plan */}
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 shadow-xl flex flex-col hover:border-white/20 transition-all duration-300 transform hover:-translate-y-2 relative group">
              ...
              <h3 className="text-2xl font-bold text-white mb-2 relative z-10">Base Program</h3>
              <p className="text-gray-400 mb-6 font-medium relative z-10">Core Interview Prep</p>
              <div className="text-4xl font-extrabold text-white mb-2 relative z-10">₹999</div>
              ...
              <button onClick={() => document.getElementById('enroll').scrollIntoView({ behavior: 'smooth' })} className="w-full relative z-10 bg-white/10 hover:bg-white/20 text-white font-bold py-4 rounded-xl transition duration-300">
                Enroll Base
              </button>
            </div>
            ...
            <div className="bg-[#0f172a] border-2 border-blue-500 rounded-3xl p-8 shadow-[0_0_30px_rgba(59,130,246,0.2)] flex flex-col transform hover:-translate-y-2 transition-transform duration-300 relative lg:scale-105 z-20">
              <div className="absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase shadow-lg">
                Most Popular
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Placement Pack</h3>
              <p className="text-gray-400 mb-6 font-medium">Total Career Transformation</p>
              <div className="text-4xl font-extrabold text-white mb-2">₹2,999 <span className="text-lg text-gray-500 line-through ml-2 font-medium">₹5,000</span></div>
              ...
              <button onClick={() => document.getElementById('enroll').scrollIntoView({ behavior: 'smooth' })} className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold py-4 rounded-xl transition duration-300 shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                Get Placement Pack
              </button>
            </div>

            {/* Add-ons */}
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 shadow-xl flex flex-col hover:border-white/20 transition-all duration-300 transform hover:-translate-y-2 relative group z-10">
              <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl pointer-events-none"></div>
              <h3 className="text-2xl font-bold text-white mb-2 relative z-10">Interview Add-on</h3>
              <p className="text-gray-400 mb-6 font-medium relative z-10">Extra Mock Sessions</p>
              <div className="text-4xl font-extrabold text-white mb-2 relative z-10">₹1,499</div>
              <p className="text-sm text-purple-400 font-semibold mb-8 relative z-10">Optional Upgrade</p>
              
              <ul className="space-y-4 mb-10 flex-1 relative z-10">
                <li className="flex items-start gap-3"><CheckCircle className="text-gray-400 shrink-0 mt-0.5" size={18} /><span className="text-gray-300">3 Additional 1:1 Mock Interviews</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="text-gray-400 shrink-0 mt-0.5" size={18} /><span className="text-gray-300">Detailed algorithmic breakdown</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="text-gray-400 shrink-0 mt-0.5" size={18} /><span className="text-gray-300">System Design dedicated review</span></li>
                <li className="flex items-start gap-3"><CheckCircle className="text-gray-400 shrink-0 mt-0.5" size={18} /><span className="text-gray-300">Improvement tracking plan</span></li>
              </ul>
              <button onClick={() => document.getElementById('enroll').scrollIntoView({ behavior: 'smooth' })} className="w-full relative z-10 bg-white/10 hover:bg-white/20 text-white font-bold py-4 rounded-xl transition duration-300">
                Add to Program
              </button>
      ...
      <section className="py-24 px-6 bg-[#0a0a0a] relative border-t border-white/5">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden transition-all duration-300">
                <button
                  className="w-full text-left p-6 flex justify-between items-center hover:bg-white/5 transition duration-300 focus:outline-none"
                  onClick={() => toggleFaq(index)}
                >
                  <span className="font-semibold text-lg text-white">{faq.question}</span>
                  <div className={`transform transition-transform duration-300 flex items-center justify-center w-8 h-8 rounded-full bg-white/5 ${faqOpen[index] ? 'rotate-180 bg-blue-500/20 text-blue-400' : ''}`}>
                    <ChevronDown size={20} />
                  </div>
                </button>
                <div className={`px-6 text-gray-400 leading-relaxed overflow-hidden transition-all duration-300 ${faqOpen[index] ? 'max-h-40 pb-6 opacity-100' : 'max-h-0 opacity-0'}`}>
                  {faq.answer}
                </div>
              </div>
            ))}
      ...
      <section id="enroll" className="py-24 px-6 bg-[#050505] relative overflow-hidden flex flex-col justify-center">
        ...
        <div className="max-w-3xl mx-auto w-full relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-lg">Next batch starts soon. Limited seats available.</p>
          </div>

          <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)]">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full p-4 bg-black/40 border border-white/10 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-white placeholder-gray-600"
                    />
                  </div>
                  <div>
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transform hover:-translate-y-1"
                  >
                    Pay & Enroll Now — ₹999
                  </button>
              ...
              <div className="text-center py-10 animate-fade-in-up">
                ...
                <h3 className="text-3xl font-bold mb-4 text-white">Enrollment Initialized!</h3>
                <p className="text-gray-300 text-lg mb-2">
                  Thank you, <span className="font-semibold text-white">{formData.name}</span>. We've received your details.
                </p>
                <p className="text-gray-400 mb-8">
                  Please check your email <b className="text-white">{formData.email}</b> for the secure payment link and batch orientation schedule.
                </p>
                <button onClick={() => setSubmitted(false)} className="px-6 py-2 border border-white/20 hover:bg-white/5 rounded-lg text-sm text-gray-300 transition-colors">
