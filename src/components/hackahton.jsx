...
const HackathonLandingPage = () => {
    ...
    if (timeLeft.isExpired) {
      return (
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">The hackathon submission period has ended.</p>
        </div>
      );
    }
    ...
    return (
      <div className="grid grid-cols-4 gap-4 max-w-md mx-auto">
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg p-4 text-center">
          <div className="text-3xl font-bold text-gray-900 dark:text-white">{timeLeft.days}</div>
        ...
        <div className="bg-gradient-to-br from-yellow-600 to-yellow-800 rounded-lg p-4 text-center">
          <div className="text-3xl font-bold text-gray-900 dark:text-white">{timeLeft.hours}</div>
        ...
        <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-lg p-4 text-center">
          <div className="text-3xl font-bold text-gray-900 dark:text-white">{timeLeft.minutes}</div>
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-lg p-4 text-center">
          <div className="text-3xl font-bold text-gray-900 dark:text-white">{timeLeft.seconds}</div>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-primary text-gray-900 dark:text-white">
  ...
  >
    � Download Certificate
            ...
            <h2 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900 dark:text-white bg-gradient-to-r from-yellow-400 via-red-400 to-yellow-400 bg-clip-text text-transparent animate-pulse">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-yellow-600 to-red-600 rounded-full px-8 py-4 inline-block animate-pulse shadow-lg">
                    <span className="text-gray-900 dark:text-white font-bold text-lg"> Congratulations to our InnovateX Hackathon 2025 Winner!</span>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mt-8">
                    ...
                    <div className="bg-gradient-to-br from-purple-900/50 to-purple-800/50 rounded-xl p-4 border border-purple-500/20 hover:border-purple-400/40 transition-colors duration-300">
                      ...
                      <div className="text-[#33bbcf] font-semibold">₹1,000 Prize</div>
          ...
          <div className="text-center animate-fade-in-up animation-delay-500">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in-up animation-delay-700">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">⏰ Time Remaining Until Submissions Close</h2>
            <CountdownTimer />
          </div>

          {/* CTA Button */}
          <div className="animate-fade-in-up animation-delay-1000">
            <a href="https://forms.gle/VChuFZ5cUo2LXvss5" target="_blank" rel="noopener noreferrer" className="btn-primary">
              � Submit Now
            </a>
          </div>
        </div>
      ...
      {/* About Section */}
      <section className={`${styles.paddingY} ${styles.paddingX} bg-gray-50 dark:bg-gray-900/50`}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">� About the Hackathon</h2>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX}`}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white"> Rounds & Selection Process</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 animate-fade-in-up animation-delay-300">
            <div className="bg-gradient-to-br from-blue-900/50 to-blue-800/50 rounded-xl p-6 text-center border border-blue-500/20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Submit your innovative project ideas and initial prototypes</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-900/50 to-yellow-800/50 rounded-xl p-6 text-center border border-yellow-500/20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Present your project to judges and demonstrate your solution</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-900/50 to-red-800/50 rounded-xl p-6 text-center border border-red-500/20">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">Winners announced and prizes distributed</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX} bg-gray-50 dark:bg-gray-900/50`}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in-up">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">� Prize Pool & Rewards</h2>
          ...
          <div className="text-center mb-12 animate-fade-in-up animation-delay-300">
            <div className="inline-block bg-gradient-to-r from-yellow-600 to-red-600 rounded-full px-8 py-4 mb-8">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">Total Prize Pool: ₹1,000 </span>
            </div>
          </div>
      ...
      <section className={`${styles.paddingY} ${styles.paddingX}`}>
        <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
          <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">� Contact Us</h2>
          ...
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Stay connected with us:</h3>
