...
const HackathonLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-primary text-white">
      {/* Hero Section */}
      <section className={`pt-32 pb-20 ${styles.paddingX} relative overflow-hidden`}>
        ...
        <div className={`max-w-7xl mx-auto text-center relative z-10`}>
          <div className="animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-yellow-400 to-red-400 bg-clip-text text-transparent">
          ...
          <div className="mb-12 animate-fade-in-up animation-delay-500">
            <h2 className="text-2xl font-semibold mb-6 text-white">⏰ Time Remaining Until Submissions Close</h2>
            <CountdownTimer />
          </div>

          {/* CTA Button */}
          <div className="animate-fade-in-up animation-delay-1000">
            <a href="https://forms.gle/VChuFZ5cUo2LXvss5" target="_blank" rel="noopener noreferrer" className="inline-block bg-gradient-to-r from-blue-600 to-red-600 hover:from-blue-700 hover:to-red-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg">
              👉 Submit Now
            </a>
          </div>
        </div>
