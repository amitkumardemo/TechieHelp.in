          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <p className="text-base mb-2 leading-relaxed">
                This is not just a course. It’s a structured internship experience with live SEO projects, mentor guidance, recommendation letter, and placement-focused support.
              </p>
