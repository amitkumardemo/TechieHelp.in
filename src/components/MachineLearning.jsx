...
const MachineLearning = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={predictive} imgLeft={true} title="TechieHelp Machine Learning Internship Program">
        <p>
          Learn regression, classification, clustering. Build ML models & deploy them with expert mentorship and hands-on projects.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our Machine Learning internship offers practical experience in building ML models and real-world projects with dedicated mentor support.
        </p>
      ...
      <Section imgSrc={predictive} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> Python, Scikit-learn, TensorFlow, Pandas, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World ML Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month Machine Learning Internship — ₹999</h2>
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ...
                  🛠️ Python & Scikit-learn Basics
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn ML concepts and tools<br />
                  ✅ Build simple ML models<br />
                  ✅ Submit project objective document
                </td>
              </tr>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ...
                  ✅ Engineer features for models<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ⚙️ Model Training & Evaluation<br />
                  🌐 Deployment & Presentation Workshop
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Train ML models<br />
                  ✅ Evaluate performance<br />
                  ✅ Deploy models and present results
                </td>
              </tr>
              <tr className="border border-cyan-500">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        <PriceBox
          ...
          features={[
            ...
            "Real-World ML Projects & Deployment",
            "🎯 Internship Benefits",
            ...
            "🏅 Certificate of Completion with GitHub Project Showcase",
        ...
        <PriceBox
          ...
          offer="₹3,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger ML Developer Profile! 🚀",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Advanced ML Research + Model Optimization",
            "Portfolio Building & Client Projects",
            "Final Hackathon + T-Shirt + YouTube Feature",
            "Certificate of Excellence for Top ML Developers",
            ...
            "⚛️ Full ML Stack Project with Deployment",
            "🔥 Python, Scikit-learn, TensorFlow Basics",
            ...
            "✅ ML Projects, Resume Boost, LinkedIn Badge",
