        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'ML tools setup guidance (Python, Jupyter, Google Colab)' },
              { type: 'normal', text: 'Introduction to internship workflow' },
              { type: 'project', level: 'beginner', title: 'Basic ML Environment Setup Task', subtitle: 'Hands-on task with Python and ML libraries setup' },
        ...
        rows: [
          {
            ...
            includes: [
              { type: 'normal', text: 'Introduction to ML fundamentals' },
              { type: 'normal', text: 'Understanding machine learning concepts' },
              { type: 'normal', text: 'Python programming for ML' },
              { type: 'normal', text: 'Weekly doubt-solving session with mentor' },
              { type: 'project', level: 'beginner', title: 'Python ML Basics Project', subtitle: 'Build simple ML programs using Python' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Unsupervised learning algorithms' },
              { type: 'normal', text: 'Feature engineering and selection' },
              { type: 'normal', text: 'Model validation techniques' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'ML Feature Engineering Project', subtitle: 'Implement feature engineering for better model performance' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced ML algorithms (Ensemble methods, SVM, KNN)' },
              { type: 'normal', text: 'Time series analysis and forecasting' },
              { type: 'normal', text: 'Natural Language Processing basics' },
              { type: 'normal', text: 'ML model optimization and hyperparameter tuning' },
              { type: 'project', level: 'intermediate', title: 'Advanced ML Algorithms Project', subtitle: 'Implement and compare different ML algorithms' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Deep learning fundamentals with TensorFlow/PyTorch' },
              { type: 'normal', text: 'Neural networks and backpropagation' },
              { type: 'normal', text: 'Computer vision with CNNs' },
              { type: 'normal', text: 'ML model deployment basics' },
              { type: 'project', level: 'hard', title: 'Deep Learning Image Classification', subtitle: 'Build CNN models for image recognition tasks' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'ML in production environments' },
              { type: 'normal', text: 'Model monitoring and maintenance' },
              { type: 'normal', text: 'ML ethics and bias detection' },
              { type: 'normal', text: 'Industry case studies and applications' },
              { type: 'project', level: 'hard', title: 'End-to-End ML Solution', subtitle: 'Develop complete ML solution from data to deployment' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'ML applications in finance and banking' },
              { type: 'normal', text: 'Predictive analytics for business' },
              { type: 'normal', text: 'Customer segmentation and recommendation systems' },
              { type: 'normal', text: 'A/B testing and experimentation' },
              { type: 'project', level: 'intermediate', title: 'Business ML Application', subtitle: 'Build ML solutions for real business problems' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'ML in healthcare and medical diagnosis' },
              { type: 'normal', text: 'Computer vision for medical imaging' },
              { type: 'normal', text: 'NLP for healthcare applications' },
              { type: 'normal', text: 'Regulatory compliance in ML' },
              { type: 'project', level: 'hard', title: 'Healthcare ML Solution', subtitle: 'Develop ML applications for healthcare industry' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'ML for autonomous systems and IoT' },
              { type: 'normal', text: 'Reinforcement learning applications' },
              { type: 'normal', text: 'Edge computing and ML' },
              { type: 'normal', text: 'Scalable ML systems design' },
              { type: 'project', level: 'hard', title: 'IoT ML Implementation', subtitle: 'Build ML solutions for IoT and autonomous systems' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced ML research and papers' },
              { type: 'normal', text: 'ML model interpretability and explainability' },
              { type: 'normal', text: 'MLOps and ML engineering practices' },
              { type: 'normal', text: 'Cloud ML platforms (AWS SageMaker, GCP AI)' },
              { type: 'project', level: 'hard', title: 'MLOps Pipeline Implementation', subtitle: 'Build end-to-end ML pipelines with monitoring' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Portfolio development and GitHub optimization' },
              { type: 'normal', text: 'ML project documentation and presentation' },
              { type: 'normal', text: 'Industry networking and LinkedIn strategy' },
              { type: 'normal', text: 'Freelancing platforms and ML consulting' },
              { type: 'project', level: 'hard', title: 'ML Portfolio Showcase', subtitle: 'Create comprehensive ML portfolio with case studies' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Company-specific ML interview preparation' },
              { type: 'normal', text: 'System design for ML systems' },
              { type: 'normal', text: 'Behavioral interview coaching' },
              { type: 'normal', text: 'Salary negotiation and offer evaluation' },
              { type: 'project', level: 'hard', title: 'ML System Design Project', subtitle: 'Design scalable ML systems for real companies' },
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'hard', title: 'Final ML Project & Presentation', subtitle: 'Complete capstone ML project with industry presentation' },
          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-yellow-300 font-bold">Machine Learning</span> Internship & Training Program
              </h1>
              <h2 className="text-xl md:text-2xl font-medium mb-2 leading-relaxed">
                Master machine learning algorithms, data science techniques, predictive modeling, and ML tools to build intelligent systems and earn a verified internship certificate that helps in placements.
              </h2>
              <p className="text-base mb-2 leading-relaxed">
                This is not just a course. It's a structured internship experience with live ML projects, mentor guidance, recommendation letter, and placement-focused support.
              </p>
              <ul className="flex flex-wrap gap-3 mb-3">
                <li className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full text-sm">✔ Live ML Projects</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 group">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">Real-World ML Projects for Portfolio</h3>
                  <p className="text-gray-600 text-sm">Build comprehensive ML portfolios with machine learning models, predictive analytics, and performance reports</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 group">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2">ML Model Reports & Analytics Dashboards</h3>
                  <p className="text-gray-600 text-sm">Professional ML reports with data-driven insights, model evaluation metrics, and predictive analytics</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 text-gray-900">
              ...
              <h3 className="text-xl font-semibold mb-2">TechieHelp Machine Learning Internship Certificate</h3>
