...
const Frontend = () => {
  ...
  return (
    <div className="bg-black-gradient min-h-screen pt-36 pb-12 px-6">
      <Section imgSrc={frontend} imgLeft={true} title="TechieHelp Front-End Developer Internship Program">
        <p>
          Build responsive and modern UIs using HTML, CSS, and JavaScript frameworks. Gain hands-on experience with real projects and expert mentorship.
        </p>
  ...
  <button className="mt-6 px-6 py-3 bg-cyan-600 text-white rounded-full hover:bg-cyan-700 transition duration-300">
    Apply Now
      ...
      <Section imgSrc={overview} imgLeft={false} title="🔥 Why Choose TechieHelp?">
        <p>
          Our front-end internship offers practical experience in building modern user interfaces with real-world projects and dedicated mentor support.
        </p>
      ...
      <Section imgSrc={frontend} imgLeft={true} title="🚀 Internship Overview">
        ...
        <p className="mt-4">
          ...
          <strong>Tools Covered:</strong> HTML, CSS, JavaScript, React, Vue, and More
        </p>
      </Section>

      <Section imgSrc={swag} imgLeft={false} title="🌟 What You Will Achieve">
        <ul className="list-disc list-inside space-y-2 text-lg">
          <li>📌 Real-World Front-End Projects for Resume</li>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 my-20 text-white">
        <h2 className="text-3xl font-bold mb-8 text-center">🔥 1-Month Front-End Developer Internship — ₹999</h2>
          ...
          <table className="min-w-full text-left text-white border border-cyan-500 rounded-lg">
            ...
            <tbody>
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn HTML structure and CSS styling<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Understand JavaScript basics<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ⚙️ React & Vue Basics<br />
                  🌐 Project Hosting Workshop
                </td>
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Learn React and Vue fundamentals<br />
              ...
              <tr className="border border-cyan-500">
                ...
                <td className="px-4 py-3 border border-cyan-500">
                  ✅ Submit final front-end project<br />
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <PriceBox
          ...
          offer="₹3,000"
          features={[
            "🔥 Special Launch Offer: Save 50%+ & Build a Stronger Front-End Developer Profile! 🚀",
        ...
        <PriceBox
          ...
          features={[
            ...
            "Certificate of Excellence for Top Front-End Developers",
            ...
            "🔥 HTML, CSS, JavaScript, React, Vue Basics",
            ...
            "✅ Front-End Projects, Resume Boost, LinkedIn Badge",
