        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'normal', text: 'Tool setup guidance (VS Code, Git, GitHub)' },
              { type: 'normal', text: 'Introduction to internship workflow' },
              { type: 'project', level: 'beginner', title: 'Basic Development Environment Setup', subtitle: 'Set up your frontend development environment' },
        ...
        rows: [
          {
            ...
            includes: [
              { type: 'normal', text: 'HTML fundamentals & semantic markup' },
              { type: 'normal', text: 'CSS basics, layouts & responsive design' },
              { type: 'normal', text: 'JavaScript fundamentals & DOM manipulation' },
              { type: 'normal', text: 'Weekly doubt-solving session with mentor' },
              { type: 'project', level: 'beginner', title: 'Static Website Project', subtitle: 'Build a responsive landing page with HTML/CSS/JS' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced CSS (Flexbox, Grid, Animations)' },
              { type: 'normal', text: 'JavaScript ES6+ features & asynchronous programming' },
              { type: 'normal', text: 'Version control with Git & GitHub' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'Interactive Web Application', subtitle: 'Create a dynamic web app with advanced CSS and JS' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'React fundamentals & component architecture' },
              { type: 'normal', text: 'State management & props' },
              { type: 'normal', text: 'React hooks & lifecycle methods' },
              { type: 'normal', text: 'Mentor doubt-solving session' },
              { type: 'project', level: 'intermediate', title: 'React Component Library', subtitle: 'Build reusable React components and manage state' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ]
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced React (Context API, Custom Hooks)' },
              { type: 'normal', text: 'API integration & data fetching' },
              { type: 'normal', text: 'Form handling & validation' },
              { type: 'normal', text: 'Testing with Jest & React Testing Library' },
              { type: 'project', level: 'intermediate', title: 'Full-Stack React Application', subtitle: 'Build a complete React app with API integration' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Modern frontend frameworks (Next.js, Vue.js)' },
              { type: 'normal', text: 'State management (Redux, Zustand)' },
              { type: 'normal', text: 'Performance optimization & code splitting' },
              { type: 'normal', text: 'Progressive Web Apps (PWAs)' },
              { type: 'project', level: 'hard', title: 'Advanced Frontend Application', subtitle: 'Develop a production-ready app with modern frameworks' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'UI/UX design principles for developers' },
              { type: 'normal', text: 'Accessibility & inclusive design' },
              { type: 'normal', text: 'Cross-browser compatibility & debugging' },
              { type: 'normal', text: 'Deployment & hosting (Vercel, Netlify)' },
              { type: 'project', level: 'hard', title: 'Portfolio Website & Case Studies', subtitle: 'Create a professional portfolio showcasing your projects' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Frontend in e-commerce & retail applications' },
              { type: 'normal', text: 'Real-time data visualization' },
              { type: 'normal', text: 'Payment gateway integration' },
              { type: 'normal', text: 'User experience optimization' },
              { type: 'project', level: 'intermediate', title: 'E-commerce Frontend Solution', subtitle: 'Build frontend for an online shopping platform' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Frontend for SaaS applications' },
              { type: 'normal', text: 'Dashboard design & data visualization' },
              { type: 'normal', text: 'Multi-tenant application architecture' },
              { type: 'normal', text: 'Subscription management UI' },
              { type: 'project', level: 'hard', title: 'SaaS Dashboard Application', subtitle: 'Develop a comprehensive SaaS platform frontend' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Frontend for mobile-first applications' },
              { type: 'normal', text: 'Progressive enhancement strategies' },
              { type: 'normal', text: 'Offline-first application development' },
              { type: 'normal', text: 'Performance monitoring & analytics' },
              { type: 'project', level: 'hard', title: 'Mobile-First Web Application', subtitle: 'Build responsive apps optimized for mobile devices' },
              { type: 'normal', text: 'Mentor doubt-solving session' }
            ]
          },
          { timeline: 'Sunday', includes: [] }
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Advanced frontend architecture patterns' },
              { type: 'normal', text: 'Micro-frontends & modular architecture' },
              { type: 'normal', text: 'Design systems & component libraries' },
              { type: 'normal', text: 'Frontend security best practices' },
              { type: 'project', level: 'hard', title: 'Scalable Frontend Architecture', subtitle: 'Design and implement enterprise-level frontend systems' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Portfolio development and case study creation' },
              { type: 'normal', text: 'Personal branding & professional networking' },
              { type: 'normal', text: 'Freelancing platforms & client acquisition' },
              { type: 'normal', text: 'Project estimation & proposal writing' },
              { type: 'project', level: 'hard', title: 'Professional Portfolio & Case Studies', subtitle: 'Create compelling portfolio with detailed project case studies' },
        ...
        rows: [
          {
            timeline: 'Monday to Saturday',
            includes: [
              { type: 'normal', text: 'Company-specific frontend interview preparation' },
              { type: 'normal', text: 'System design for frontend applications' },
              { type: 'normal', text: 'Code review & optimization techniques' },
              { type: 'normal', text: 'Salary negotiation & offer evaluation' },
              { type: 'project', level: 'hard', title: 'Frontend System Design Project', subtitle: 'Design scalable frontend systems for large applications' },
        ...
        rows: [
          {
            ...
            includes: [
              ...
              { type: 'project', level: 'hard', title: 'Capstone Frontend Project & Presentation', subtitle: 'Complete final project with industry-standard presentation' },
          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-yellow-300 font-bold">Frontend Development</span> Internship & Training Program
              </h1>
              <h2 className="text-xl md:text-2xl font-medium mb-2 leading-relaxed">
                Master HTML, CSS, JavaScript, React, and modern frontend frameworks to build stunning user interfaces and earn a verified internship certificate that helps in placements.
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Through TechieHelp's comprehensive training, real-world projects, and expert mentorship, you'll be prepared for high-demand roles in frontend development across startups and established companies.
            </p>
          </div>
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Master industry-standard frontend development tools and frameworks used by developers to build stunning and interactive user interfaces.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2 text-gray-900">
              ...
              <h3 className="text-xl font-semibold mb-2">TechieHelp Frontend Development Internship Certificate</h3>
