...
const FluidCard = ({ title, detail, index }) => (
  ...
  >
    ...
    <div className="relative z-10 flex items-start gap-3">
      ...
      <div>
        <h4 className="text-gray-900 dark:text-white font-poppins font-semibold text-[15px] leading-[22px] mb-1">
          {title}
        </h4>
        <p className="text-gray-500 dark:text-dimWhite font-poppins text-[13px] leading-[20px] opacity-80 group-hover:opacity-100 transition-opacity">
          {detail}
        </p>
      </div>
    </div>
...
const WhoWeAre = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden py-16 lg:py-24 ss:px-16 px-6 flex justify-center items-center bg-white dark:bg-primary min-h-[500px]">
      ...
      <div className="xl:max-w-[1280px] w-full flex lg:flex-row flex-col gap-16 lg:gap-16 items-center relative z-[10]">
        ...
        >
          ...
          <motion.h2 variants={itemVariants} className="font-poppins font-semibold ss:text-[40px] text-[32px] text-gray-900 dark:text-white ss:leading-[52px] leading-[42px] mb-6">
            Most businesses lose customers in the <span className="text-gradient">first few minutes.</span>
          </motion.h2>

          <motion.div variants={itemVariants} className="font-poppins text-[15px] leading-[26px] mb-8 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-5 rounded-2xl backdrop-blur-sm">
            <p className="text-gray-500 dark:text-dimWhite mb-3">A user fills your form. You’re busy. No response. The lead goes cold.</p>
            <p className="text-red-400 font-semibold text-[16px]"> That’s lost revenue.</p>
          </motion.div>

          <motion.div variants={itemVariants} className="w-full h-px bg-gray-100 dark:bg-white/10 mb-8" />

          <motion.h3 variants={itemVariants} className="font-poppins font-semibold text-[24px] text-gray-900 dark:text-white mb-6">
          ...
          <ul className="space-y-3 mb-8">
            {[
              ...
              <motion.li variants={itemVariants} key={i} className="flex items-start gap-3 text-gray-500 dark:text-dimWhite text-[16px] font-poppins leading-[24px]">
                ...
                <span className="text-gray-900 dark:text-white/90">{text}</span>
              </motion.li>
            ))}
          </ul>
        ...
        <div className="flex-1 relative flex flex-col justify-center items-center w-full">
          ...
          >
            <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/20 p-6 rounded-3xl border border-blue-500/20 backdrop-blur-md relative overflow-hidden">
              ...
              <h4 className="font-poppins font-bold text-[22px] text-gray-900 dark:text-white mb-2"> This is not a tool.</h4>
          ...
          >
            ...
            <div className="relative z-10 w-full p-1 border border-gray-200 dark:border-white/10 rounded-[32px] bg-gray-100 dark:bg-white/5 backdrop-blur-sm">
              <div className="bg-[#0a0a0a] rounded-[28px] p-8 w-full border border-white/5 relative overflow-hidden">
                ...
                <h3 className="font-poppins font-bold text-[24px] text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                ...
                <div className="relative text-center">
                  ...
                  <h4 className="font-poppins font-bold text-[18px] text-gray-900 dark:text-white relative z-10">
