    ...
    <Router>
      <div className={`bg-primary w-full`}>
        ...
        <a
          ...
          className="fixed bottom-4 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-colors duration-200"
        >
          <svg
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-20 right-6 z-50 bg-primary hover:bg-blue-600 text-white p-3 rounded-full shadow-lg transition-colors duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
